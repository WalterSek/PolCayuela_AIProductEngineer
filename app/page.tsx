      ...
      <header className="w-full max-w-7xl mx-auto px-6 pt-16 pb-8 md:pt-24 md:pb-12">
        <FadeIn>
          ...
          <div className="flex flex-wrap gap-4 mb-12 max-w-5xl">
            ...
            <a href="/CV Pol Cayuela AI Product Engineer.pdf" download className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-zinc-200 text-zinc-900 rounded-lg hover:bg-zinc-50 transition-colors text-sm font-medium shadow-sm">
